...
<template>
  <div style="height: 100vh; overflow: hidden; background-color: aliceblue">
    ...
    <div style="display: flex; width: 28%; margin: 150px auto; background-color: white;
...
<!--            </div>-->
          ...
          <div style="text-align: right"><a style="text-decoration: none; color: dodgerblue" href=" ">还没有账号？去注册</a></div>
        </div>
      </div>
    </div>
